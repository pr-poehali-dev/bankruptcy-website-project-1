...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Политика конфиденциальности | БезДолгов59";
    window.scrollTo(0, 0);
  }, []);
          ...
          <section className="pt-28 pb-12 px-4 bg-gradient-to-br from-slate-50 to-blue-50">
            <div className="container mx-auto max-w-4xl">
              ...
              <p className="mt-4 text-gray-600">
                Обновлено: 01 февраля 2021 года
              </p>
            </div>
          </section>
            ...
            <div className="container mx-auto max-w-4xl">
              <div className="prose prose-slate prose-lg max-w-none">
                <p>
                  ...
                  которую сайт БезДолгов59, (далее — БезДолгов59) расположенный на
                  доменном имени bezdolgov59.ru (а также его субдоменах), может
                  получить о Пользователе во время использования сайта bezdolgov59.ru
                ...
                <p>
                  ...
                  уполномоченные сотрудники на управление сайтом БезДолгов59, которые
                ...
                <p>
                  1.1.5. «Сайт БезДолгов59» — это совокупность связанных между собой
                  веб-страниц, размещенных в сети Интернет по уникальному адресу
                  (URL): bezdolgov59.ru, а также его субдоменах.
                </p>
                <p>
                  1.1.6. «Субдомены» — это страницы или совокупность страниц,
                  расположенные на доменах третьего уровня, принадлежащие сайту
                  БезДолгов59, а также другие временные страницы, внизу который указана
                  контактная информация Администрации.
                </p>
                <p>
                  1.1.5. «Пользователь сайта БезДолгов59» (далее Пользователь) — лицо,
                  имеющее доступ к сайту БезДолгов59, посредством сети Интернет и
                  использующее информацию, материалы и продукты сайта БезДолгов59.
                </p>
                <p>
                ...
                <p>
                  ...
                  сети, через который Пользователь получает доступ на БезДолгов59.
                </p>

                <h2>2. Общие положения</h2>
                <p>
                  2.1. Использование сайта БезДолгов59 Пользователем означает согласие
                ...
                <p>
                  ...
                  Пользователь должен прекратить использование сайта БезДолгов59.
                </p>
                <p>
                  2.3. Настоящая Политика конфиденциальности применяется к сайту
                  БезДолгов59. БезДолгов59 не контролирует и не несет ответственность
                  за сайты третьих лиц, на которые Пользователь может перейти по
                  ссылкам, доступным на сайте БезДолгов59.
                </p>
                <p>
                ...
                <p>
                  ...
                  БезДолгов59 или при подписке на информационную e-mail рассылку.
                </p>
                <p>
                  ...
                  заполнения форм на сайте БезДолгов59 и включают в себя следующую
                  информацию:
                </p>
                <ul>
                ...
                <p>
                  3.3. БезДолгов59 защищает Данные, которые автоматически передаются
                ...
                <p>
                  3.3.2. БезДолгов59 осуществляет сбор статистики об IP-адресах своих
                ...
                <ul>
                  ...
                  <li>
                    ...
                    БезДолгов59, если Пользователь дал согласие на создание учетной
                    записи.
                  </li>
                  <li>
                ...
                <p>
                  ...
                  БезДолгов59, и давать согласие на их обработку.
                </p>
                <p>
                ...
                <p>
                  ...
                  к которой он может иметь доступ как к части сайта БезДолгов59, несет
                  лицо, предоставившее такую информацию.
                </p>
                <p>
                  7.5. Пользователь соглашается, что информация, предоставленная ему
                  как часть сайта БезДолгов59, может являться объектом
                  интеллектуальной собственности, права на который защищены и
                  принадлежат другим Пользователям, партнерам или рекламодателям,
                  которые размещают такую информацию на сайте БезДолгов59. Пользователь
                  не вправе вносить изменения, передавать в аренду, передавать на
                  условиях займа, продавать, распространять или создавать производные
                  работы на основе такого Содержания (полностью или в части), за
                ...
                <p>
                  ...
                  находящихся в свободном публичном доступе на сайте БезДолгов59)
                ...
                <p>
                  ...
                  иных коммуникационных данных, содержащихся на сайте БезДолгов59 или
                ...
                <p>
                  ...
                  информацию, размещенную пользователем на сайте БезДолгов59, включая,
                ...
                <p>
                  ...
                  размещения на сайте БезДолгов59, если иное не предусмотрено новой
                ...
                <p>
                  ...
                  <a
                    href="mailto:infofaq@bezdolgov59.ru"
                ...
                <p>
                  ...
                  адресу{" "}
                  <a
                    href="https://bezdolgov59.ru/privacy-policy/"
                    className="text-primary hover:underline"
                  >
                    bezdolgov59.ru/privacy-policy/
                  </a>
                </p>

                <div className="mt-8 p-6 bg-slate-50 rounded-xl border border-slate-200 not-prose">
                  <p className="text-sm text-gray-500 mb-1">Обновлено: 01 февраля 2021 года</p>
