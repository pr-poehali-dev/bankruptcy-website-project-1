                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-6 border-t space-y-3">
                    ...
                    <a 
                      ...
                      className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 hover:opacity-90 transition-opacity group"
                    >
                      ...
                      <div className="text-white">
                        <div className="font-medium text-sm">Свяжитесь с нашим менеджером в ВК</div>
                      </div>
                      <Icon name="ExternalLink" className="text-white/80 ml-auto" size={16} />
                    </a>
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-3 rounded-lg bg-gradient-to-br from-blue-400 to-blue-600 hover:opacity-90 transition-opacity group"
                    >
                      <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                        <Icon name="Send" size={20} className="text-white" />
                      </div>
                      <div className="text-white">
                        <div className="font-medium text-sm">Свяжитесь с нашим менеджером в Телеграм</div>
                      </div>
                      <Icon name="ExternalLink" className="text-white/80 ml-auto" size={16} />
                    </a>
                  </div>
      ...
      <footer className="bg-slate-900 text-white py-12 px-4">
        <div className="container mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li className="flex items-center gap-2">
                  ...
                  Пермь, ул. Екатерининская 109А, оф. 305
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            © 2026 БезДолгов59. Все права защищены.
          </div>
        </div>
      </footer>
